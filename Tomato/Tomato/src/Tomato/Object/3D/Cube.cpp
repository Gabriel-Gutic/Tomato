...
namespace Tomato
{
	Cube::Cube()
	{
		...
		m_Sides[CubeSide::Bottom].SetRotation(Float3(1.0f,  0.0f, 0.0f));
		...
		m_Sides[CubeSide::Top].SetRotation(Float3(1.0f, 0.0f, 0.0f));
		...
		m_Sides[CubeSide::East].SetRotation(Float3(0.0f, 1.0f, 0.0f));
		...
		m_Sides[CubeSide::West].SetRotation(Float3( 0.0f, 1.0f, 0.0f));
		...
		m_Sides[CubeSide::North].SetRotation(Float3(0.0f, 0.0f,  1.0f));
		...
		m_Sides[CubeSide::South].SetRotation(Float3(0.0f, 0.0f, 1.0f));
